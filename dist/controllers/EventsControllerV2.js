...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context4; _forEachInstanceProperty(_context4 = ownKeys(Object(source), true)).call(_context4, function (key) { (0, _defineProperty2["default"])(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context5; _forEachInstanceProperty(_context5 = ownKeys(Object(source))).call(_context5, function (key) { _Object$defineProperty(target, key, _Object$getOwnPropertyDescriptor2(source, key)); }); } } return target; }
...
var EventsControllerV2 = (_dec = (0, _httpVerb["default"])('post'), _dec2 = (0, _route["default"])('/v2/ping'), _dec3 = (0, _anonymous["default"])(), _dec4 = (0, _httpVerb["default"])('get'), _dec5 = (0, _route["default"])('/v2/events/:eventNamePrefix?*'), _dec6 = (0, _serverSentEvents["default"])(), _dec7 = (0, _httpVerb["default"])('get'), _dec8 = (0, _route["default"])('/v2/devices/events/:eventNamePrefix?*'), _dec9 = (0, _serverSentEvents["default"])(), _dec10 = (0, _httpVerb["default"])('get'), _dec11 = (0, _route["default"])('/v2/devices/:deviceIDorName/events/:eventNamePrefix?*'), _dec12 = (0, _serverSentEvents["default"])(), _dec13 = (0, _httpVerb["default"])('post'), _dec14 = (0, _route["default"])('/v2/devices/events'), (_class = /*#__PURE__*/function (_Controller) {
  (0, _inherits2["default"])(EventsControllerV2, _Controller);

  var _super = _createSuper(EventsControllerV2);

  function EventsControllerV2(eventManager, deviceManager) {
    var _this;

    (0, _classCallCheck2["default"])(this, EventsControllerV2);
  ...
  (0, _createClass2["default"])(EventsControllerV2, [{
    key: "ping",
    value: function () {
    ...
    value: function getEvents(eventNamePrefix) {
      ...
      var subscriptionID = this._eventManager.subscribe(eventNamePrefix, // eslint-disable-next-line flowtype/require-parameter-type, flowtype/require-return-type
      function () {
    ...
    key: "getDeviceEvents",
    value: function () {
      var _getDeviceEvents = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(deviceIDorName, eventNamePrefix) {
        var _this4 = this;
    ...
    key: "publish",
    value: function () {
      var _publish = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(postBody) {
        var eventData;
    ...
    value: function _startKeepAlive() {
      ...
      return (0, _setInterval2["default"])(function () {
        if (new Date() - _this6._lastEventDate >= KEEP_ALIVE_INTERVAL) {
          _this6.response.write('event:heartbeat\n');

          _this6.response.write('data:\n\n');
    ...
    value: function _pipeEvent(event) {
      var eventMerged = _objectSpread({
        name: event.name
      }, (0, _eventToApi["default"])(event));

      try {
        this.response.write("data:".concat((0, _stringify["default"])(eventMerged), "\n\n"));
...
var _default = EventsControllerV2;
