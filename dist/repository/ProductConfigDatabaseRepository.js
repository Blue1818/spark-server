...
var ProductConfigDatabaseRepository = /*#__PURE__*/function (_BaseRepository) {
  (0, _inherits2["default"])(ProductConfigDatabaseRepository, _BaseRepository);

  var _super = _createSuper(ProductConfigDatabaseRepository);

  function ProductConfigDatabaseRepository(database) {
    var _this;

    (0, _classCallCheck2["default"])(this, ProductConfigDatabaseRepository);
    _this = _super.call(this, database, _collectionNames["default"].PRODUCT_CONFIGS);
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_database", void 0);
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_collectionName", _collectionNames["default"].PRODUCT_CONFIGS);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getByProductID", /*#__PURE__*/function () {
...
var _default = ProductConfigDatabaseRepository;
