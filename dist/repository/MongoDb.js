...
var MongoDb = /*#__PURE__*/function (_BaseMongoDb) {
  ...
  function MongoDb(_url) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "count", /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(collectionName) {
        var query,
            _args2 = arguments;
                    ...
                    return _regenerator["default"].wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            return _context.abrupt("return", collection.count(_this.__translateQuery(query), {
                              timeout: false
                            }));
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          ...
                          case 2:
                            ...
                            return _context3.abrupt("return", _this.__translateResultItem(insertResult.ops[0]));
                    ...
                    return _regenerator["default"].wrap(function _callee7$(_context7) {
                      while (1) {
                        switch (_context7.prev = _context7.next) {
                          ...
                          case 2:
                            modifyResult = _context7.sent;
                            return _context7.abrupt("return", _this.__translateResultItem(modifyResult.value));
                    ...
                    return _regenerator["default"].wrap(function _callee11$(_context11) {
                      while (1) {
                        switch (_context11.prev = _context11.next) {
                          case 0:
                            return _context11.abrupt("return", collection.remove(_this.__translateQuery(query)));
        ...
        return _regenerator["default"].wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 4:
                return _context13.abrupt("return", callback(_this._database.collection(collectionName))["catch"](function (error) {
                  return logger.error({
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_init", /*#__PURE__*/function () {
      var _ref14 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee14(url, options) {
        var database;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_isDbReady", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee15() {
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              ...
              return _context15.abrupt("return", _promise["default"].resolve());

            case 2:
              return _context15.abrupt("return", new _promise["default"](function (resolve) {
